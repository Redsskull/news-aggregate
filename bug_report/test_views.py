...
class SubmitBugReportViewTest(TestCase):
    ...
    def test_submit_bug_report_view_POST_adds_new_bug_report(self):
        ...
        # Check if a new bug report was added
        self.assertEqual(BugReport.objects.first().title, 'Test Bug')
        # Check if the title of the new bug report is correct
    ...
    def test_submit_bug_report_view_GET(self):
        ...
        self.assertTemplateUsed(response, 'submit_bug_report.html')
